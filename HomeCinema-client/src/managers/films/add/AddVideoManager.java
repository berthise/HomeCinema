 ...
 * @author seb
 */
public class AddVideoManager extends ModuleManager {

  FilmModel film = null;

  public AddVideoManager(FilmModel f) {
    this("add video to the film", f);
  }

  public AddVideoManager(String name, FilmModel f) {
    super(name);
    film = f;
  }
  ...
  public void exec() {
    ...
    try {
      ...
      System.out.println("Error: abording video edition");
    }
  }
