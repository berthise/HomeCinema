 ...
 * @author seb
 */
public class AddVideoManager extends ModuleManager implements Manager_if {

  FilmModel film = null;

  public AddVideoManager(LoggedModel log, FilmModel f) {
    super(log);
    film = f;
  }
