...
public class ListProductsManagedBean {
	...
	page = lastPage = 1;
	allGenres = null;
	staticNewProduct = Ejbs.product().getFilteredProducts(null, null, null, null, null, null, OrderTypes.NEW, 9, null, ProductTypes.All).list;
	staticTopProduct = Ejbs.product().getFilteredProducts(null, null, null, null, null, null, OrderTypes.RATING, 9, null, ProductTypes.All).list;
    }
	...
	FilteredListProductsDto flpdto = Ejbs.product().getFilteredProducts(null, null, null, null, null, null, OrderTypes.ALPH, N_PER_PAGE, (page - 1) * N_PER_PAGE, ProductTypes.Main);
	updateLastPage(flpdto);
	return flpdto.list;
    }

    private List<ProductDto> getAllProducts() {
	FilteredListProductsDto flpdto = Ejbs.product().getFilteredProducts(null, null, null, null, null, null, OrderTypes.ALPH, N_PER_PAGE, (page - 1) * N_PER_PAGE, ProductTypes.Pack);
	updateLastPage(flpdto);
	return flpdto.list;
    }

    private List<ProductDto> getSearchProducts(SearchParams params) {
	FilteredListProductsDto flpdto = Ejbs.product().getFilteredProducts(params.actorId, params.directorId, params.genres, params.title, params.date1, params.date2, OrderTypes.NO, N_PER_PAGE, (page - 1) * N_PER_PAGE, ProductTypes.All);
	updateLastPage(flpdto);
	return flpdto.list;
    }
	...
	return Ejbs.product().getFilteredProducts(null, null, null, null, null, null, OrderTypes.RAND, n, 0, ProductTypes.Main).list;
    }
