(function () {
	...
	var n = function (t) {
	    var n = e.extend({reblinkProbability: 1 / 3, blinkMin: .01, blinkMax: .5, loopMin: .5, loopMax: 2, color: "ORANGE", glow: ["0 0 80px Orange", "0 0 30px Red", "0 0 6px Yellow"], off: 0, blink: 0, autoOn: true}, t);
	...
	return $('#code404').novacancy({
	    'blink': 1,
	    'off': 1,
	    'color': 'Green',
	    'glow': ['0 0 80px Green', '0 0 30px Green', '0 0 6px DarkGreen']
	});
    });
